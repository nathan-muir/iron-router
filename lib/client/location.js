...
var popped = false;
var anchorSelector = Meteor.settings && Meteor.settings.public && Meteor.settings.public.IronRouterAnchorSelector ? Meteor.settings.public.IronRouterAnchorSelector : 'a[href]';
...
IronLocation.start = function () {
  ...
  $(document).on('click', anchorSelector, onclick);
  this.isStarted = true;
...
IronLocation.stop = function () {
  ...
  $(window).off('click', anchorSelector, onclick);
